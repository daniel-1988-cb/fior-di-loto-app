...
export default function V2ReportsPage() {
  ...
  const subNavWithCounts = [
    {
      items: [
        { href: "/v2-preview/reports", label: "Tutti i report", badge: reports.length },
        { href: "/v2-preview/reports/preferiti", label: "Preferiti", badge: bySection.favorites.length },
        { href: "/v2-preview/reports/dashboard", label: "Dashboard", badge: bySection.dashboard.length },
        { href: "/v2-preview/reports/standard", label: "Standard", badge: bySection.standard.length },
        { href: "/v2-preview/reports/premium", label: "Premium", badge: bySection.premium.length },
        { href: "/v2-preview/reports/custom", label: "Personalizzabile", badge: 0 },
        { href: "/v2-preview/reports/goals", label: "Obiettivi" },
      ],
    },
    {
      title: "Cartelle",
      items: [{ href: "/v2-preview/reports/data-connector", label: "Data connector" }],
    },
  ];

  return (
    <V2Shell subNav={{ title: "Report", groups: subNavWithCounts }}>
      ...
      <div className="space-y-3">
        {reports.map((r) => (
          <Link key={r.key} href={`/v2-preview/reports/${r.key}`}>
