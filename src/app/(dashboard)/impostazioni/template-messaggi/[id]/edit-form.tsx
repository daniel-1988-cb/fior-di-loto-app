...
import { ArrowLeft, Save, Trash2, Variable } from "lucide-react";
import {
  Button,
  Card,
  Input,
...
export function EditForm({ initial }: { initial: TemplateInitial }) {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <header>
        ...
        <h1 className="text-3xl font-bold tracking-tight">Modifica template</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Aggiorna nome, canale, categoria o contenuto del modello.
        </p>
      </header>
      ...
      <Card className="border-danger/30 p-5">
        <div className="flex items-center justify-between gap-4">
          <div>
            <h2 className="font-semibold text-danger">Elimina template</h2>
            <p className="mt-1 text-sm text-muted-foreground">
              Rimuove definitivamente questo template. Operazione non reversibile.
            </p>
          </div>
          <Button
            type="button"
